        ...
        <div class="container" data-aos="fade-up">
            ...
            <table width=700 align=center border=3 cellspacing=4 cellpadding=2 bordercolor=black>
                ...
                <body>
                    ...
                    <tr>
                        <td>
                            <center><?php echo $pecah['id_mapel'];?></center>
                        </td>
                        <td>
                            <center><?php echo $pecah['nama_mapel'];?></center>
                        </td>
                        <td>
                            <center><?php echo $pecah['kelas_mapel'];?></center>
                        </td>

                        <td>
                            <center><?php echo $pecah['guru_mapel'];?></center>
                        </td>
                        <td>
                            <center>
                                <a href="hapusmapel.php?&id=<?php echo $pecah['id_mapel'];?>"><INPUT TYPE="button"
                                        value="Hapus" class="btn btn-danger btn-kirim"></a>
                                <a href="ubahmapel.php?&id=<?php echo $pecah['id_mapel'];?>"><INPUT TYPE="button"
                    ...
                    <tr>
                        <td>
                            <center>
                                <a href="tambahmapel.php"><INPUT TYPE="button" value="Tambah Data"
