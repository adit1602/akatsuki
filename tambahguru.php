    ...
    <section id="services" class="services section-bg">
        <div class="container" data-aos="fade-up">
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <button name="save" class="btn btn-primary btn-kirim">Simpan</button>
            </form>
            <?php 
                if (isset($_POST['save']))
                {
                    
                    $koneksi->query("INSERT INTO guru (nama_guru,email_guru,telepon_guru)VALUES('$_POST[nama]','$_POST[email]','$_POST[telepon]')");

                    echo "<div class='alert alert-info'>Data tersimpan</div>";
                    echo "<meta http-equiv='refresh' content='1;url=adminguru.php'>";
                }
                ?>
