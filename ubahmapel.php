...
?>
            ...
            <form method="post" enctype="multipart/form-data">
                <div>
                    ...
                    <input type="text" name="nama" value="<?php echo $pecah['nama_mapel'];?>">
                </div>
                <div>
                    <label>Mapel Kelas</label><br>
                    <input type="text" name="kelas" value="<?php echo $pecah['kelas_mapel'];?>">
                </div>
                <div>
                    <label>Guru Mapel</label><br>
                    <input type="text" name="guru" value="<?php echo $pecah['guru_mapel'];?>">
                </div>
                <br>
