...
<body>
    ...
    <section id="services" class="services section-bg">
        <div class="container" data-aos="fade-up">
            ...
            <table width=800 align=center border=3 cellspacing=4 cellpadding=2 bordercolor=black>
                ...
                <body>
                    ...
                    <tr>
                        <td>
                            <center><?php echo $pecah['id_murid'];?></center>
                        </td>

                        <td>
                            <center><?php echo $pecah['nama_murid'];?></center>
                        </td>
                        <td>
                            <center><?php echo $pecah['email_murid'];?></center>
                        </td>
                        <td>
                            <center><?php echo $pecah['telepon_murid'];?></center>
                        </td>
                        <td>
                            <center><?php echo $pecah['kelas'];?></center>
                        </td>
                        <td>
                            <center>
                                <a href="hapusmurid.php?&id=<?php echo $pecah['id_murid'];?>"><INPUT TYPE="button"
                                        value="Hapus" class="btn btn-danger btn-kirim"></a>
                                <a href="ubahmurid.php?&id=<?php echo $pecah['id_murid'];?>"><INPUT TYPE="button"
                    ...
                    <tr>
                        <td>
                            <center>
                                <a href="tambahmurid.php"><INPUT TYPE="button" value="Tambah Data"
