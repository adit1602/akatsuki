...
?>
            ...
            <form method="post" enctype="multipart/form-data">
                <div>
                    ...
                    <input type="text" name="nama" value="<?php echo $pecah['nama_guru'];?>">
                </div>
                <div>
                    <label>Email Guru</label><br>
                    <input type="text" name="email" value="<?php echo $pecah['email_guru'];?>">
                </div>
                <div>
                    <label>Telepon Guru</label><br>
                    <input type="text" name="telepon" value="<?php echo $pecah['telepon_guru'];?>">
                </div>
                <div>
                    <label>Password Guru</label><br>
                    <input type="text" name="password" value="<?php echo $pecah['password_guru'];?>">
                </div>
                <br>
